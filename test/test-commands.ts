...
export class TestCommand13 implements LeafCommand {
    ...
    @Option({ key: 'option1', description: 'Test option1 for TestCommand13', conflicts: 'option2' })
    public option1!: string

    @Option({ key: 'option2', description: 'Test option2 for TestCommand13', conflicts: 'option1' })
...
export class TestCommand8 implements LeafCommand {
    ...
    @Option({ key: 'option-test-command-8', description: 'Test option for TestCommand' })
    public option1!: string
...
export class TestCommand4 implements LeafCommand {
    @Option({ key: 'option-test-command-4', description: 'test option for TestCommand4', type: 'boolean' })
    public option1!: boolean

    @Argument({ key: 'argument123123', description: 'test argument for TestCommand4', required: true })
...
export class TestCommand3 implements GroupCommand {
    ...
    @Option({ key: 'option-test-command-3', description: 'option1 key for testCommand3' })
    public option1!: string
}

export class TestCommand implements GroupCommand {
    @Option({ key: 'test-command-option-1', description: 'Test option for TestCommand' })
    public option1!: string
...
export class TestCommand7 implements GroupCommand {
    @Option({ key: 'option-test-command-7', description: 'Test option for TestCommand7' })
    public vmi!: string
