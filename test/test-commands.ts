...
export class TestCommand12 implements LeafCommand {
  ...
  public run(): void {
    console.log(`I'm the testCommand ${this.name}`);
    console.log(
      `Aggregated relation "argument1" value: ${this.aggregatedRelation.argument1}`
    );
    console.log(
      `Aggregated relation "option1" value: ${this.aggregatedRelation.option1}`
    );
  }
}
...
export class TestCommand8 implements LeafCommand {
  ...
  public run(): void {
    console.log(
      `I'm the testCommand ${this.name}. option-test-command-8: ${this.option1}`
    );
  }
}
...
export class TestCommand4 implements LeafCommand {
  ...
  public run(): void {
    console.log(`I'm the testCommand ${this.name}`);
    console.log(
      `option-test-command-4 : ${this.option1}; argument123123: ${this.argument1}`
    );
  }
}
